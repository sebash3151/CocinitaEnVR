...
public class MeshDestroy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (active)
        {
            ...
            if (timer >= 10)
            {
                ...
                {
                    //Debug.Log(item.GameObject.transform.position.y);
    ...
    {
        var originalMesh = objeto.GetComponent<MeshFilter>().mesh;
        ...
        {
            parts[i].MakeGameobject(objeto); //this
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(GameObject original) //MeshDestroy
        {
